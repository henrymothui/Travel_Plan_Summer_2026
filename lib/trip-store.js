...
import { isCoverKey, resolveCoverKey } from "./covers";
...
export function emptyTripDraft(overrides = {}) {
  ...
  return {
    ...
    cover: resolveCoverKey(overrides.cover, id),
...
export function validateTripMeta(meta, { requireTitle = true } = {}) {
  ...
  if (meta.cover !== undefined && !isCoverKey(meta.cover)) {
    return "trip.cover is invalid";
  }
